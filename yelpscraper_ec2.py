...
class Scraper:
    ...
    def __init__(self,keyword,city,limit=10):
                ...
                if a.text == str(self.counter) and int(a.text) <= self.limit:
                    ...
                    for li in lilist1:
                        ...
                        if len(self.AllInternalEmails) == 0:
                            ...
                            data_dict = {"business_name": business_name,"site_url": site_url,"EmailAddress": repr(self.AllInternalEmails)}
...
if __name__ == '__main__':
    ...
    scraper_obj = Scraper(keyword,city,limit)
    scraper_obj.scrape()
