...
sender_address = 'codemarket.notifications@gmail.com'
sender_pass = 'CodeMarket_Jay'
...
client = pymongo.MongoClient('mongodb+srv://sumi:'+urllib.parse.quote('sumi@')+'123@codemarket-staging.k16z7.mongodb.net/jc_linkedin?retryWrites=true&w=majority')
db = client.get_database('jc_linkedin')
